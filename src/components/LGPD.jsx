...
export default function LGPD() {
    ...
    useEffect(() => {
        ...
        function marketing() {
            ...
            setNoscript(`<iframe src="https://www.googletagmanager.com/ns.html?id=GTM-XXXXXXX"
        ...
        <>
            ...
            <section className={Styles.lgpdContainer} id='lgpdContainer'>
                <div className={Styles.lgpdContent} id='lgpdContent'>  
                    <p>
                        Usamos cookies para personalizar sua experiência. Para saber mais acesse nossa <Link href="/politicas">
